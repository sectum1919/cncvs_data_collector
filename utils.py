...
LastEditTime: 2022-10-05 16:33:05
...
def read_video(input_file: str, frame_boundary: tuple) -> tuple:
    '''
    description: 
    param {str}   input_file
    param {tuple} frame_boundary
    return {list, tuple} image list, frameSize
    '''
